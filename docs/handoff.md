...
### 4. 新着資料からキーワード一致で自動予約する（2026-07-29要件・設計確定、段階1〜6完了）
...
次は段階7として、手動カート予約・即時予約・予約取消へ共通書込ゲートを接続する。
自動予約Coordinator、通知、UI、Worker接続はまだ実装しない。
