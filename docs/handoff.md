...
### 4. 新着資料からキーワード一致で自動予約する（2026-07-29要件・設計確定、段階1〜5実装済み）
...
## 新着キーワード自動予約（2026-07-29段階1〜5実装済み）
...
結果分類、送信館記録を維持している。次は段階6として、このコミットのCI APKでカート予約と
即時予約を実機確認する。その確認が終わるまで段階7の共通書込ゲートや自動予約Coordinatorへ進まない。
